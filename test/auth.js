...
describe('mouth', function () {
	...
	it('should construct the expected Authorization header for a Twitter status update', function () {
		...
		var result = mouth.authorizationHeaderString('POST', 'https://api.twitter.com/1/statuses/update.json', queryParams, postParams, consumerKey, consumerSecret, userToken, userSecret, callbackURL);
